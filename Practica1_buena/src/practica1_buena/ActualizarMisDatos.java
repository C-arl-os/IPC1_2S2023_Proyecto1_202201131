 ...
 * @author sanci
 */
public class ActualizarMisDatos extends javax.swing.JFrame {
    ...
    String indiceClase;
    String codigo;
    public ActualizarMisDatos(ArrayList<Profesor> Profe,ArrayList<Cursos> curso,ArrayList<Alumnos> Alumno, int indice,String indiceClase,ArrayList<Actividades> actividad,String codigo) {
        this.Profe = Profe;
        this.curso = curso;
        this.Alumno = Alumno;
        this.indice=indice;
